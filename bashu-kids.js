(function(){
var SHOES=[
{id:"dunkshot",brand:"ASICS",name:"DUNKSHOT MB",price:"5,500〜7,000円",cat:"junior",style:["speed","all"],budget:[1,2],width:["normal","wide"],priority:["light","cushion"],tags:["ミニバス定番","軽量","日本人向け"],desc:"ミニバスの定番中の定番。日本人の足型に合わせた幅広設計で、初めてのバッシュに最適。軽量で動きやすく、成長期の足をしっかりサポートします。",sizing:"+0cm〜+0.5cm（実寸通り〜やや大きめ）",rating:4.6,reviews:1284,sizeCm:[18,24],image:"PRODUCT_IMAGE_dunkshot"},
{id:"gelimprove",brand:"ASICS",name:"GELIMPROVE 2",price:"6,000〜8,000円",cat:"junior",style:["all","power"],budget:[1,2],width:["normal","wide"],priority:["cushion","durable"],tags:["クッション◎","安定感","部活向け"],desc:"GELテクノロジーによるクッション性が魅力。着地時の衝撃をしっかり吸収するので、膝への負担が気になる成長期のお子さんに。",sizing:"+0cm〜+0.5cm（実寸通り〜やや大きめ）",rating:4.5,reviews:632,sizeCm:[20,26],image:"PRODUCT_IMAGE_gelimprove"},
{id:"teamhustle",brand:"NIKE",name:"Team Hustle D",price:"5,000〜7,500円",cat:"junior",style:["all","speed"],budget:[1,2],width:["narrow","normal"],priority:["design","light"],tags:["かっこいい","NBA選手愛用","軽量"],desc:"NBAの雰囲気を感じられるデザインで、子どものモチベーションが上がる一足。やや細めの作りなので、足幅が細い子に特におすすめ。",sizing:"+0.5cm〜+1.0cm（やや大きめ推奨）",rating:4.4,reviews:875,sizeCm:[18,24],image:"PRODUCT_IMAGE_teamhustle"},
{id:"crossemup",brand:"adidas",name:"Cross Em Up Select",price:"5,500〜7,500円",cat:"junior",style:["all","speed"],budget:[1,2],width:["normal"],priority:["design","durable"],tags:["コスパ◎","デザイン豊富","通気性"],desc:"コスパが良く、カラーバリエーションも豊富。通気性に優れたメッシュアッパーで蒸れにくい。足幅は標準的な作りです。",sizing:"+0.5cm（やや大きめ推奨）",rating:4.3,reviews:421,sizeCm:[19,25],image:"PRODUCT_IMAGE_crossemup"},
{id:"curry",brand:"UNDER ARMOUR",name:"Curry 4 Low FloTro",price:"12,000〜16,000円",cat:"mid",style:["speed","all"],budget:[2,3],width:["narrow","normal"],priority:["light","design"],tags:["カリー愛用","グリップ◎","本格派"],desc:"NBA・ステフィン・カリーのシグネチャーモデル。圧倒的なグリップ力と軽量性で、素早い動きを重視するガード向け。",sizing:"+0.5cm〜+1.0cm（やや大きめ推奨）",rating:4.7,reviews:892,sizeCm:[23,29],image:"PRODUCT_IMAGE_curry"},
{id:"gelhoop",brand:"ASICS",name:"GELHOOP V16",price:"11,000〜14,000円",cat:"mid",style:["speed","all"],budget:[2,3],width:["normal","wide"],priority:["light","cushion"],tags:["部活定番","軽量","日本製"],desc:"中高生の部活で圧倒的シェアを誇る定番モデル。軽さとフィット感のバランスが秀逸で、オールラウンドに使えます。",sizing:"+0cm〜+0.5cm（実寸通り〜やや大きめ）",rating:4.8,reviews:2145,sizeCm:[22,29],image:"PRODUCT_IMAGE_gelhoop"},
{id:"nova",brand:"ASICS",name:"NOVA SURGE 3",price:"14,000〜18,000円",cat:"mid",style:["power","all"],budget:[3],width:["normal","wide"],priority:["cushion","durable"],tags:["クッション最強","パワープレー","安定感"],desc:"ASICSの最高峰クッション搭載モデル。ゴール下のパワープレーやリバウンドを多くこなすビッグマン向け。重さはあるが安定感は抜群。",sizing:"+0cm〜+0.5cm（実寸通り〜やや大きめ）",rating:4.6,reviews:543,sizeCm:[23,30],image:"PRODUCT_IMAGE_nova"},
{id:"lebron",brand:"NIKE",name:"LeBron NXXT Gen",price:"15,000〜20,000円",cat:"mid",style:["power","all"],budget:[3],width:["normal"],priority:["cushion","design"],tags:["レブロン愛用","衝撃吸収","存在感"],desc:"NBAの王様レブロン・ジェームズのモデル。クッションと安定感を両立し、パワフルなプレーを支えます。デザインのインパクトも大。",sizing:"+0.5cm〜+1.0cm（ナイキは大きめ推奨）",rating:4.5,reviews:387,sizeCm:[24,30],image:"PRODUCT_IMAGE_lebron"},
{id:"kd",brand:"NIKE",name:"KD17",price:"15,000〜19,000円",cat:"mid",style:["speed","all"],budget:[3],width:["narrow","normal"],priority:["light","design"],tags:["KD愛用","フィット感◎","万能"],desc:"ケビン・デュラントのシグネチャー。足を包み込むようなフィット感が特徴で、どんなポジションにも対応できる万能型。",sizing:"+0.5cm〜+1.0cm（ナイキは大きめ推奨）",rating:4.6,reviews:456,sizeCm:[24,30],image:"PRODUCT_IMAGE_kd"}
];
